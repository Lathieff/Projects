...
import 'package:sales_erp/society/Commission/multiple_field_advisor.dart';
import 'package:sales_erp/widgets/status_bar.dart';

class MultipleContributionScreen extends StatelessWidget {
  const MultipleContributionScreen({super.key});
    ...
    return GestureDetector(
      onTap: () {
        if (item.name == 'Field Advisor') {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const FieldAdvisorScreen()),
          );
        }
      },
      child: Container(
