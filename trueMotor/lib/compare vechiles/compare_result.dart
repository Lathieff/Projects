...
class _CompareResultPageState extends State<CompareResultPage> {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildNavItem(Icons.shopping_cart_outlined, 'Buy', false),
          _buildNavItem(Icons.sell_outlined, 'Sell', false),
          _buildNavItem(Icons.compare_arrows, 'Compare', true),
        ],
      ),
    );
  }
  ...
  Widget _buildNavItem(IconData icon, String label, bool isActive) {
    return Column(
      ...
      children: [
        Icon(icon, color: isActive ? Colors.white : Colors.white60, size: 24),
        Text(
          label,
          style: TextStyle(
