...
import 'package:truemotor/screens/compare%20vechiles/compare_result.dart';
...
class _CompareVehicleScreenState extends State<CompareVehicleScreen> {// Compare is at index 3 in screenshot
  void _goToHome() {
    Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(builder: (_) => const HomeScreen()),
