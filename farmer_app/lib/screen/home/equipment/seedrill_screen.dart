...
class SeedDrillScreen extends StatelessWidget {
  const SeedDrillScreen({super.key});
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              _buildEquipmentCard(
                imageUrl: "assets/equip/seedrill_1.png",
                profileUrl: "assets/equip/profile/profile_7.png",
                ownerName: "Karthikeyan",
                rating: "4.2",
                distance: "2.3 km away",
                model: "Pneumatic Seed Drill",
                price: "1200",
                width: width,
                r: r,
                context: context,
              ...
              _buildEquipmentCard(
                imageUrl: "assets/equip/seedrill_2.png",
                profileUrl: "assets/equip/profile/profile_8.png",
                ownerName: "Prakash",
                rating: "4.2",
                distance: "2.3 km away",
                model: "Heavy Duty Rotavator",
                price: "1200",
                width: width,
                r: r,
                context: context,
